  ...
  return (
    <main className={styles.container}>
        ...
        <p className={styles.description}>
          Hi! My name's Jordi, a Computer Engineering student at UPC-FIB and current <a href="https://en.wikipedia.org/wiki/Site_reliability_engineering" className={styles.link}>Site Reliability Engineer</a> intern based in Barcelona.
          <br></br><br></br>
